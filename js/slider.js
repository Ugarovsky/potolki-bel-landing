...
var multiItemSliderTwo = (function () {
  return function (selector, config) {
    var
      _mainElement = document.querySelector(selector), 
      _sliderWrapper = _mainElement.querySelector('.slider__wrapper_two'), 
      _sliderItems = _mainElement.querySelectorAll('.slider__item_two'), 
      _sliderControls = _mainElement.querySelectorAll('.slider__control_two'), 
      _sliderControlLeft = _mainElement.querySelector('.slider__control_left_two'),
      _sliderControlRight = _mainElement.querySelector('.slider__control_right_two'), 
      _wrapperWidth = parseFloat(getComputedStyle(_sliderWrapper).width),
      _itemWidth = parseFloat(getComputedStyle(_sliderItems[0]).width),
      _positionLeftItem = 0, 
      _transform = 0,
    ...
    var _controlClick = function (e) {
      var direction = this.classList.contains('slider__control_right_two') ? 'right' : 'left';
      e.preventDefault();
      _transformItem(direction);
    };
...
var sliderTwo = multiItemSliderTwo('.slider_two');